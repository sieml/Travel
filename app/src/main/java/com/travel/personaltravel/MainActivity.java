...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onRestart() {
        ...
        if (AiLYApplication.isLogged) {
            ...
            loginedIv.setVisibility(View.VISIBLE);
        }else {
            loginTv.setVisibility(View.VISIBLE);
            loginedIv.setVisibility(View.GONE);
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginTv = (TextView) findViewById(R.id.travel_home_page_login_item_tv);
        loginedIv = (ImageView) findViewById(R.id.travel_home_page_logged_item_iv);
